...
import MyBookingTest from "../../../MyBookingTest/MyBookingTest";
    ...
    <div className="dashboard d-flex text-center">
      <ProSidebar>
        <Menu iconShape="square">
          ...
          <MenuItem
            onClick={() => setControl("myTestBooking")}
            title="My medical test booking request"
            icon={"s"}
          >
            My medical test request
          </MenuItem>
          <MenuItem
      ...
      <div className="container text-center">
        ...
        {control === "myTestBooking" && <MyBookingTest></MyBookingTest>}
