...
import BookingTestList from "../../../BookingTestList/BookingTestList";
    ...
    <div className="dashboard d-flex text-center">
      <ProSidebar>
        <Menu iconShape="square">
          ...
          <MenuItem onClick={() => setControl("bookingTestList")} icon={"g"}>
            Medical Test Booking Request
          </MenuItem>
        </Menu>
      </ProSidebar>
      <div className="container text-center mt-2">
        ...
        {control === "bookingTestList" && <BookingTestList></BookingTestList>}
