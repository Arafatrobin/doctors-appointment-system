...
import BookTests from "./components/BookTests/BookTests";
import BankingPay from "./components/Auth/PaymentGetWay/BankingPay";
import OtherPaymentStatus from "./components/Auth/PaymentGetWay/OtherPaymentStatus";
import BookTestForm from "./components/BookTests/BookTestForm/BookTestForm";
      ...
      <userContext.Provider value={[loggedInUser, setLoggedInUser]}>
        <Router>
          ...
          <Switch>
            ...
            <PrivateRoute exact path="/bookTests">
              <BookTests></BookTests>
            </PrivateRoute>
            <PrivateRoute exact path="/testbook/:testname">
              <BookTestForm></BookTestForm>
            </PrivateRoute>
            ...
            <Route path="/bankingPay">
              <BankingPay></BankingPay>
            </Route>
            <Route path="/otherPaymentStatus">
              <OtherPaymentStatus></OtherPaymentStatus>
            </Route>
